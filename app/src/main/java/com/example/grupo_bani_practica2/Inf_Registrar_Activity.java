...
public class Inf_Registrar_Activity extends AppCompatActivity {
    ...
    public void consultapormatricula(View v){
        ...
        if(!mat.isEmpty()) {
            ...
            if (fila.moveToFirst()) {
                ...
                Toast.makeText(this, "No exite un registro con dicha matricula", Toast.LENGTH_LONG).show();
            }
            bd.close();
        }else {
            Toast.makeText(this,"Debes introducir la matricula del estudiante primero", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void modificar(View v){
        ...
        if(!nom.isEmpty()&&!mat.isEmpty()&&!nac.isEmpty()&&!desc.isEmpty()) {
            ...
            if (cant == 1) {
                ...
                Toast.makeText(this, "No existe un registro con la matricula ingresada", Toast.LENGTH_SHORT).show();
            }
        }else {
            Toast.makeText(this,"Debes consultar el registro del estudiante primero",Toast.LENGTH_LONG).show();
        }
        //editcodigo.setText("");
        editnombre.setText("");
        editmatricula.setText("");
    ...
    public void bajaporcodigo(View v){
        ...
        if(!mat.isEmpty()) {
            ...
            Toast.makeText(this,"Debes de introducir la matricula del estudiante primero",Toast.LENGTH_LONG).show();
        }
        //editcodigo.setText("");
        editnombre.setText("");
        editmatricula.setText("");
